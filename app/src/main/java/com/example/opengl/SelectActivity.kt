...
class SelectActivity : ComponentActivity() {
    ...
    private val transitions by lazy {
        listOf(
            ButtonItemBean(R.string.transition_slide, R.string.transition_slide_info) {
                navTransition(TransitionActivity.TransitionMode.SLIDE)
            },
            ButtonItemBean(R.string.transition_wipe, R.string.transition_wipe_info) {
                navTransition(TransitionActivity.TransitionMode.LINEAR_WIPE)
            },
            ButtonItemBean(R.string.transition_radial, R.string.transition_radial_info) {
                navTransition(TransitionActivity.TransitionMode.RADIAL_UNFOLD)
            },
            ButtonItemBean(R.string.transition_fade, R.string.transition_fade_info) {
                navTransition(TransitionActivity.TransitionMode.FADE)
            },
            ButtonItemBean(R.string.transition_rotating, R.string.transition_rotating_info) {
                navTransition(TransitionActivity.TransitionMode.ROTATING)
            },
            ButtonItemBean(R.string.transition_blur, R.string.transition_blur_info) {
                navTransition(TransitionActivity.TransitionMode.ZOOM_BLUR)
            },
            ButtonItemBean(R.string.transition_burn, R.string.transition_burn_info) {
