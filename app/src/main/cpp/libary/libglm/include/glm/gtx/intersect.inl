...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER bool intersectRaySphere
        ...
        typename genType::value_type b =
                typename genType::value_type(2) * dot(rayStarting, rayDirection);
        typename genType::value_type c =
                dot(rayStarting, rayStarting) - sphereRadius * sphereRadius;
